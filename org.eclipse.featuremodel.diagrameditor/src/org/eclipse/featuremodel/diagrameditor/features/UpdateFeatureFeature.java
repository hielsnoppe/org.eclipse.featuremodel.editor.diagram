...
public class UpdateFeatureFeature extends AbstractUpdateFeature {
  ...
  /**
   * Updates the Feature name field. It copies the latest name value from the
   * Feature model object to the graphics algorithm of name text field.
   * 
   * @param context
   *          The context.
  ...
  /**
   * Check whether the Feature name in the name text field of the pictogram
   * element is up to date, that means whether the graphics algorithm of this
   * name text field contain the latest values from the Feature model object.
   * 
   * @param context
   *          The context.
   * @return true if name field of the pictogram model needs to be updated with
   *         the latest values. from the Feature model object.
   */
  @Override
