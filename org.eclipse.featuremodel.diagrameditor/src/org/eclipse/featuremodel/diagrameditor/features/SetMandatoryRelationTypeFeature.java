 ...
 * the {@link RelationType#Optional} to the {@link RelationType#Mandatory}.
 * 
 */
public class SetMandatoryRelationTypeFeature extends AbstractCustomFeature {
   ...
   * {@link RelationType#Optional} or {@link RelationType#Mandatory}.
   * 
   * @param context
   *          The context.
   ...
   * element represents a Group and the current Group relation type is the
   * {@link RelationType#Optional}.
   * 
   * @param context
   *          The context.
   * @return true if the pictogram element represents a Group and the current
   *         Group relation type is the {@link RelationType#Optional}
   */
  @Override
