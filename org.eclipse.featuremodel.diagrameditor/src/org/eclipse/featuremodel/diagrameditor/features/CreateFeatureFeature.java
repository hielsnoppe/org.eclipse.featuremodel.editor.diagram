...
public class CreateFeatureFeature extends AbstractCreateFeature {
  ...
  public Object[] create(ICreateContext context) {
    ...
    // if the new Feature is wanted to be added as child of an existing Feature
    // create Group
    ...
    // Update the graphical representation of the Group relation type (e.g.
    // mandatory,
    // optional)
    if (newFeature.getParentGroup() != null) {
      Connection connection = BOUtil.getPictogramElementForBusinessObject(newFeature.getParentGroup(), Connection.class, getFeatureProvider());
  ...
  private void drawGroup(Group group, Feature newFeature, Feature parentFeature) {
    ...
    ContainerShape newFeatureCS = BOUtil.getPictogramElementForBusinessObject(newFeature, ContainerShape.class, getFeatureProvider());
