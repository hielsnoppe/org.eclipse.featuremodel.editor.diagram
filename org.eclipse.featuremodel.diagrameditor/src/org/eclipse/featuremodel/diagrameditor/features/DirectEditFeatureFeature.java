...
public class DirectEditFeatureFeature extends AbstractDirectEditingFeature {
   ...
   * direct edited. This implementation returns <code>true</code> if the
   * pictogram element represents a Feature and graphics algorithm is a text
   * field.
   * 
   * @param context
   *          The context.
  ...
  /**
   * Sets the new value of the Feature model object and initiate the update of
   * the referenced pictogram element.
   * 
   * @param value
   *          The new name value.
   * @param context
  ...
  public void setValue(String value, IDirectEditingContext context) {
    ...
    if (obj instanceof Feature) {
      ...
      // Explicitly update the main shape to display the new value in the
      // diagram.
