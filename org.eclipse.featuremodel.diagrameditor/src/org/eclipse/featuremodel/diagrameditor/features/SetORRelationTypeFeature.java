...
/**
 * Feature handle changing the set relation type of a Group model object from
 * the {@link RelationType#XOR} to the {@link RelationType#OR}.
 * 
 */
public class SetORRelationTypeFeature extends AbstractCustomFeature {
  ...
  /**
   * Decides if the change relation type feature is available with the given
   * context. This implementation returns <code>true</code> if the pictogram
   * element represents a Group and the current Group relation type is the
   * {@link RelationType#OR} or {@link RelationType#XOR}.
   * 
   * @param context
   *          The context.
   ...
   * modified. This implementation returns <code>true</code> if the pictogram
   * element represents a Group and the current Group relation type is the
   * {@link RelationType#XOR}.
   * 
   * @param context
   *          The context.
   * @return true if the pictogram element represents a Group and the current
   *         Group relation type is the {@link RelationType#XOR}
   */
  @Override
