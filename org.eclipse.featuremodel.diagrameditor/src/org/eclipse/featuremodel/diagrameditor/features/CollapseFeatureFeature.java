...
/**
 * Feature handle collapsing of Feature Diagram elements. A Features with child
...
public class CollapseFeatureFeature extends AbstractCustomFeature {
  ...
  /**
   * Decides if the collapse feature is available with the given context. This
   ...
   * collapsed. This implementation returns <code>true</code> if the selected
   * pictogram element represents a Feature, it has child Features and is of the
   * type {@link Properties#PROP_VAL_CONTAINER_TYPE_EXPANDED}.
   * 
   * @param context
   *          The context.
  ...
  public void execute(ICustomContext context) {
    ...
    Graphiti.getPeService().setPropertyValue(selectedPE, Properties.PROP_KEY_CONTAINER_INIT_X, String.valueOf(selectedPE.getGraphicsAlgorithm().getX()));
    Graphiti.getPeService().setPropertyValue(selectedPE, Properties.PROP_KEY_CONTAINER_INIT_Y, String.valueOf(selectedPE.getGraphicsAlgorithm().getY()));

    // collapse all child elements
    collapse(feature);

    // set type of the given Feature pictogram element to collapsed
    Graphiti.getPeService().setPropertyValue(selectedPE, Properties.PROP_KEY_CONTAINER_TYPE, Properties.PROP_VAL_CONTAINER_TYPE_COLLAPSED);
