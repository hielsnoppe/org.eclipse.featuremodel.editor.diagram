...
/**
 * {@link FMEFeatureProvider} is used by the Graphiti framework to find out
 * which operations are supported by this editor in the current situation.
 * 
 */
public class FMEFeatureProvider extends DefaultFeatureProvider {
  ...
  /**
   * Create features create Feature Model objects and their graphical
   * representations. In the graphics framework they will be visualized in an
   * editor as create tools.
   * 
  ...
  /**
   * Direct editing features handle direct editing functionality (including drop
   * down lists and text completion).
   * 
   * @param context
   *          The context.
  ...
  /**
   * Update features do the synchronization work and transport data from Feature
   * Model to pictograms model elements.
   * 
   * @param context
   *          The context.
  ...
  /**
   * Delete features remove the graphical representations of Feature Model
   * objects as well as the Feature Model objects itself.
   * 
   * @param context
   *          The context.
  ...
  /**
   * Gets custom features. Custom features can do anything (e.g. changing Group
   * relation type).
   * 
   * @param context
   *          The context.
  ...
  /**
   * Called in case an existing object on the diagram is moved. Needs to return
   * a feature that can handle the move operation or <code>null</code> to
  ...
  /**
   * Called in case a pictogram element on the diagram is resized. Needs to
   * return a feature that can handle the resize operation.
   * 
   * @param context
   *          The context.
   * @return The feature that handle the move.
   ...
   * anchor. This implementation forbid the reconnection.
   * 
   * @param context
   *          the context
  ...
  /**
   * Remove features remove the graphical representations of Feature Model
   * objects.
   * 
   * @param context
   *          the context
  ...
  public IRemoveFeature getRemoveFeature(IRemoveContext context) {
    Object obj = getBusinessObjectForPictogramElement(context.getPictogramElement());
    if (obj instanceof Feature) {
      return new RemoveFeatureFeature(this);
    }
