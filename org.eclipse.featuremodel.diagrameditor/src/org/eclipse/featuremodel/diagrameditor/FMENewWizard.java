...
/**
 * The wizard for creation of new Feature Diagrams. A new Feature Model is
 * created or an existing loaded.
 * 
 */
public class FMENewWizard extends Wizard implements INewWizard {
  ...
  public boolean performFinish() {
    IRunnableWithProgress op = new WorkspaceModifyOperation(null) {
      ...
      protected void execute(IProgressMonitor monitor) throws CoreException, InterruptedException {
        ...
        FMENewWizard.this.featureDiagram = FMEDiagramEditorUtil.createFeatureDiagram(FMENewWizard.this.modelFilePage.getFeatureDiagramURI(),
        ...
        if (featureDiagram != null) {
          try {
            ...
            ErrorDialog.openError(getContainer().getShell(), "Error opening Feature Diagram editor", null, e.getStatus());
          }
        }
      }
    };
  ...
  private void openDiagram(Resource diagramResource) throws PartInitException {
    DiagramEditorInput editorInput = new DiagramEditorInput(this.featureDiagram.getURI(), FMEDiagramEditor.DIAGRAM_TYPE_PROVIDER_ID);
    PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().openEditor(editorInput, FMEDiagramEditor.DIAGRAM_EDITOR_ID);
  }
