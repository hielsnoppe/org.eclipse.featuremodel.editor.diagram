...
/**
 * This class handle the context menu action in the project explorer to create a
 * new Feature Diagram.
 * 
 * 
 */
public class FMECreateWizardAction implements IObjectActionDelegate {
  ...
  public void run(IAction action) {
    if (this.selection instanceof IStructuredSelection) {
      ...
      wizard.init(this.tartgetPart.getSite().getWorkbenchWindow().getWorkbench(), (IStructuredSelection) this.selection);
   ...
   * the criteria specified in the plugin.xml file. Then the delegate is
